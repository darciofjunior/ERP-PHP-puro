/*Essa biblioteca tem por objetivo fixar a primeira linha de uma Tabela, o que é muito comum em Excel 
"Congelar Painéis" de modo a usuário não perder os rótulos das Colunas quando estiver mexendo na Barra de Rolagem ...*/
...
var tableScroll = (function() {
    ...
    function TableScroll(id) {
        ...
        /*Em uma análise prática detectamos que em uma Tela de 1366 pixels, a somatória da 
        largura da coluna mais os afastamentos esquerda e direita podem ser de no máximo 
        1348 pixels, ou seja só utilizamos 98,68% ...*/
        var largura_util_tela_cabecalho = Math.ceil(screen.width * 0.9868)
        var largura_esquerda_cabecalho  = (largura_util_tela_cabecalho - table.width) / 2
        ...
        function position() {
            ...
            if ((size = ((w != lastWidth) || (h != lastHeight))) || (st != lastScrollTop) || (sl != lastScrollLeft)) {
                /*Essa linha abaixo controla o início "Esquerda" do Cabeçalho Fixo, já tentei retirá-la 
                e deixar apenas a segunda abaixo que está com a medida Fixa, mas se eu arrancar essa 
                Primeira não funciona a de baixo ... ???*/
                hHeaderRelStyle.left = (((cellWidth = (testCellDim().x - tableDim().iX)) + (lastScrollLeft = sl)) * -1) + 'px';//position
                hHeaderRelStyle.left = largura_esquerda_cabecalho;//Essa medida do Cabeçalho é sempre o dobro da medida dos Itens -0,5 ...
        ...
        if (
            ...
            InitializeMe(function() {
                ...
                if (
                    ...
                    midAbsDivStyle.overflowX    = 'hidden';
        ...
        /*A largura esquerda de Itens sempre é a metade da variável "largura_esquerda_cabecalho" 
        encontrada acima + 0.5 ... 
        Cheguei nessa fórmula devido muitas tentivas e erros e acabou dando certo, agora porque ??? rs*/
        var largura_esquerda_itens = (largura_esquerda_cabecalho / 2) + 0.5
        var overrideStyles = {
            ...
            //Essa linha abaixo controla o início "Esquerda" dos itens ...
            left: [{keys: ['left'], value: largura_esquerda_itens}],
