...
function selecionar(form, campo, totallinhas, cor_origem) {
    ...
    if(campo_sel.checked == true) {//Checkbox Principal está marcado ...
        for (var i = 0; i < linhas; i++) document.getElementById('chkt_pedido_venda_item'+i).checked = true
        //Cor das Linhas ...
        if(navigator.appName == 'Netscape') {
        ...
        for (var i = 0; i < linhas; i++) document.getElementById('chkt_pedido_venda_item'+i).checked = false
        //Cor das Linhas ...
