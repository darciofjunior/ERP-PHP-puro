...
<table width='1200' border='0' cellspacing='1' cellpadding='1' onmouseover="total_linhas(this)" align='center'>
	...
	<tr class="linhadestaque" align="center">
		...
		<td>
			<font color='#FFFFFF' title='Qtde do Último Orçamento' size='-1'>
				Qtde
			</font>
		</td>
		<td>
...
?>
	<tr onclick="window.location = 'pa_componente_revenda_esp2.php?id_produto_acabado=<?=$campos_esp_custo_liberado[$i]['id_produto_acabado'];?>'" onmouseover="sobre_celula(this, '#CCFFCC')" onmouseout="fora_celula(this, '#E8E8E8')" class="linhanormal" align='center'>
		...
		<td align='left'>
		<?
			if($campos_esp_custo_liberado[$i]['status_custo'] == 1) {//Já está liberado
		?>
...
<?
		...
		<td align='left'>
		<?
			//Verifica se existe fornecedor e margem de lucro através do id_produto_acabado
...
?>
	<tr onclick="window.location = 'pa_componente_revenda_esp2.php?id_produto_acabado=<?=$campos_principal[$i]['id_produto_acabado'];?>'" onmouseover="return sobre_celula(this, '#CCFFCC')" onmouseout="return fora_celula(this, '#E8E8E8')" class="linhanormal" align='center'>
		...
		<td>
<?
//Verifica a última qtde desse item em orçamento
			...
			$campos2 = bancos::sql($sql);
			if(count($campos2) == 1) {//Achou esse item em algum orçamento
		?>
			<font title="Orçamento N.º <?=$campos2[0]['id_orcamento_venda'];?>">
...
<table border="0" width="70%" align="center" cellspacing ='1' cellpadding='1'>
	...
	<tr class='linhanormal'>
		...
		<td width="20%">
			<input type='checkbox' name='chkt_so_custos_nao_liberados' value='1' title="Só Custos não Liberados" class="checkbox" checked id='label2'>
			<label for='label2'>
	...
	<tr class='linhanormal'>
		<td width="20%">
			<input type='checkbox' name='chkt_depto_tecnico' value='1' title="Consultar todos os DEPTO. TÉCNICO" onClick='limpar()' class="checkbox" checked id='label3'>
			<label for='label3' title="Consultar todos os DEPTO. TÉCNICO">
