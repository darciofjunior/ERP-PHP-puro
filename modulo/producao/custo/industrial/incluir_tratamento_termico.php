...
if($passo == 1) {
    if($_POST['inserir'] == 1) {
        foreach($_POST['cmb_produto_insumo'] as $id_produto_insumo) {
            ...
            if(count($campos) == 0) {
                $sql = "INSERT INTO `pacs_vs_pis_trat` (`id_pac_pi_trat`, `id_produto_acabado_custo`, `id_produto_insumo`) VALUES (NULL, '$_POST[id_produto_acabado_custo]', '$id_produto_insumo') ";
                bancos::sql($sql);
                $valor = 2;
            }else {
                $valor = 3;
...
?>
        <Script Language = 'JavaScript'>
            ...
            if(valor == 2) window.location = 'alterar_etapa5.php?id_produto_acabado_custo=<?=$_POST['id_produto_acabado_custo'];?>'
        </Script>
<?
    }
}
...
<html>
<head>
<title>.:: Consultar Produto(s) Insumo(s) de Tratamento(s) Térmico(s) ::.</title>
...
<table width='70%' border='0' cellspacing='1' cellpadding='1' align='center'>
    ...
    <tr class='linhacabecalho' align='center'>
        <td colspan='2'>
            Consultar Produto(s) Insumo(s) de Tratamento(s) Térmico(s)
        </td>
    </tr>
