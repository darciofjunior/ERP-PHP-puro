...
require('../../../../lib/intermodular.php');//Essa biblioteca é requirida dentro da Biblioteca de Custos ...
...
if(!empty($_POST['id_pac_maquina'])) {
    $sql = "UPDATE `pacs_vs_maquinas` SET `tempo_hs` = '$_POST[txt_tempo4]' WHERE `id_pac_maquina` = '$_POST[id_pac_maquina]' LIMIT 1 ";
    bancos::sql($sql);
    $valor = 1;
...
?>
    ...
    <tr class='linhanormal'>
        ...
        <td>
            <input type='text' name='txt_real_h4' value='<?=number_format($campos[0]['custo_h_maquina'], 2, ',', '.');?>' size='12' class='textdisabled' disabled>
        </td>
    </tr>
    <tr class='linhanormal'>
        <td>
        ...
        <td>
            <input type='text' name='txt_total4' value='<?=number_format($total_rs, 2, ',', '.');?>' size='12' class='textdisabled' disabled>
        </td>
    </tr>
    <tr class='linhacabecalho' align='center'>
        <td colspan='2'>
