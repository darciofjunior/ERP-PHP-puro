        ...
        <td width='20%'>
            ...
            <?
                ...
                $sql = "SELECT id_plr_periodo, CONCAT(DATE_FORMAT(data_inicial, '%d/%m/%Y'), ' à ', DATE_FORMAT(data_final, '%d/%m/%Y'), ' - Pagto: ', DATE_FORMAT(data_pagamento, '%d/%m/%Y')) AS periodo 
                        FROM `plr_periodos` 
                        WHERE id_plr_periodo <> '1' ORDER BY id_plr_periodo ";
...
<table width='60%' border='0' cellspacing ='1' cellpadding='1' align='center' onmouseover='total_linhas(this)'>
    ...
    <tr class='linhacabecalho' align='center'>
        <td colspan='4'>
            Período(s)
            &nbsp;&nbsp;-&nbsp;&nbsp;
            <a href='incluir_periodo.php' title='Incluir Período'>
...
?>
    <tr class='linhanormal' align='center'>
        ...
        <td width='30' bgcolor='#CCCCCC'>
            <img src='../../../../imagem/menu/excluir.png' border='0' alt='Excluir Períodos' title='Excluir Períodos'>
        </td>
    </tr>
<?
        for($i = 0; $i < $linhas ; $i++) {
?>
    <tr class='linhanormal' onclick="cor_clique_celula(this, '#C6E2FF')" onmouseover="sobre_celula(this, '#CCFFCC')" onmouseout="fora_celula(this, '#E8E8E8')" align='center'>
        ...
        <td>
        <?
//Só posso estar excluindo o último período ...
            if(($i + 1) == $linhas) {
        ?>
                <img src='../../../../imagem/menu/excluir.png' border='0' onclick="excluir_item('<?=$campos[$i]['id_plr_periodo'];?>')" alt='Excluir Período' title='Excluir Período'>
        <?
            }
        ?>
        </td>
