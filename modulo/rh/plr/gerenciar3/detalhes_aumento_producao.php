...
<html>
<head>
<title>.:: Detalhes de Aumento de Produção ::.</title>
...
<table width='90%' border='0' align='center' cellspacing='1' cellpadding='1' onmouseover='total_linhas(this)'>
    <tr class='linhacabecalho' align='center'>
        <td colspan='4'>
            Detalhes de Aumento Produção
        </td>
    </tr>
<?
//Aqui eu busco todos os Aumentos de Produções do PLR ...
    $sql = "SELECT plrap.*, CONCAT(DATE_FORMAT(pp.data_inicial, '%d/%m/%Y'), ' à ', DATE_FORMAT(pp.data_final, '%d/%m/%Y')) AS periodo 
...
?>
    <tr class='atencao' align='center'>
        <td colspan='5'>
            NÃO HÁ AUMENTO DE PRODUÇÃO(ÕES) CADASTRADO(S) NESSE PERÍODO.
        </td>
    </tr>
<?
    }else {
