...
//Esse Macete só irá servir quando for Impressos os PLR(s) dos Funcionários da Empresa Grupo ...
    ...
    //Linha em Branco ...
            $pdf->Cell($GLOBALS['ph']*97, 8, '', 'LR', 1, 'L');
    //Vlr Produção / Absenteismo ...
            $pdf->SetFont('Arial', 'B', 14);
            $pdf->Cell($GLOBALS['ph']*39.5, 5.2, '    Valor Produção / Absenteismo: ', 'L', 0, 'L');
            $pdf->SetFont('Arial', '', 14);
            $pdf->Cell($GLOBALS['ph']*57.5, 5.2, 'R$ '.number_format($campos[$i]['valor_red_absenteismo'], 2, ',', '.'), 'R', 1, 'L');
    //Linha em Branco ...
            $pdf->Cell($GLOBALS['ph']*97, 8, '', 'LR', 1, 'L');
    //Desconto Sindicato ...
            $pdf->SetFont('Arial', 'B', 14);
