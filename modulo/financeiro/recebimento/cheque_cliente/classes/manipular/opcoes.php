...
<html>
<head>
<title>.:: Opções de Cheque de Cliente ::.</title>
...
<table width='60%' cellpadding='1' cellspacing='1' align='center'>
    ...
    <tr class='linhanormal'>
        <td>
            <input type='radio' name='opt_item' value='3' title='Efetuar Devolução de Cheque' id='opt3'>
            <label for='opt3'>Efetuar Devolução de Cheque</label>
        </td>
    </tr>
    <tr class='linhanormal'>
        <td>
