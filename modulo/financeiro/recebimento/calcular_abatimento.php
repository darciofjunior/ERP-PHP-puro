...
/***************************************************************/
    var dias_corridos       = diferenca_datas(document.form.txt_data_pagamento.value, '<?=$_GET['data_vencimento_alterada'];?>')
...
<table border="0" width='80%' align="center" cellspacing ='1' cellpadding='1'>
    ...
    <tr class='linhanormal'>
        ...
        <td>
            ...
            <img src="../../../imagem/calendario.gif" width="12" height="12" border="0" alt="Calend&aacute;rio Normal" style="cursor:hand" onclick="javascript:nova_janela('../../../calendario/calendario.php?campo=txt_data_pagamento&tipo_retorno=1', 'CALENDÁRIO', '', '', '', '', 270, 240, 'c', 'c')">
        </td>
    </tr>  
    <tr class="linhacabecalho" align="center">
        <td colspan="2">
