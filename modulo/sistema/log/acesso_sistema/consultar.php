...
//Carrega a Listagem dos Funcionários
...
//Busca do Login através do funcionário selecionado da combo na Tela anterior ...
    $sql = "SELECT id_login 
            FROM `logins` 
            WHERE `id_funcionario` = '$cmb_funcionario' LIMIT 1 ";
    $campos_login = bancos::sql($sql);
    if(count($campos_login) == 1) {//Se existir login p/ o Funcionário ...
        $id_login_current = $campos_login[0]['id_login'];
    }else {//Caso não exista, este sempre será 0.1 (Macete) ...
...
<table width='70%' border='0' cellspacing='1' cellpadding='1' align='center'>
    ...
    <tr class="linhanormal" align='center'>
        <td>
            ...
            <?
                //Traz todos os funcionários que ainda estão trabalhando da Empresa selecionada ...
