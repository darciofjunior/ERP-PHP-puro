...
$mensagem[2] = "<font class='confirmacao'>DADO(S) BANCÁRIO(S) INCLUIDO(S) COM SUCESSO.</font>";
$mensagem[3] = "<font class='erro'>DADO(S) BANCÁRIO(S) JÁ EXISTENTE.</font>";
...
<html>
<head>
<title>.:: Incluir Dado(s) Bancário(s) ::.</title>
...
<table width='70%' border='0' cellspacing='1' cellpadding='1' align='center' onmouseover="total_linhas(this)">
    <tr class="linhacabecalho" align="center">
        <td colspan='4'>
            Incluir Dado(s) Bancário(s) - Consultar Fornecedor
        </td>
    </tr>
...
<table border="0" width='60%' align="center" cellspacing ='1' cellpadding='1'>
    <tr class='linhacabecalho' align='center'>
        <td colspan='2'>
            Incluir Dado(s) Bancário(s) p/ o Fornecedor => 
            <font color="yellow">
    ...
    <tr class="linhanormal">
        ...
        <td>
            <input type="text" name="txt_agencia" title="Digite a Agência" maxlength="30" size="32" class="caixadetexto">
        </td>
    </tr>
    <tr class="linhanormal">
        <td>
        ...
        <td>
            <input type="text" name="txt_conta_corrente" title="Digite o Número da Conta Corrente" maxlength="30" size="32" class="caixadetexto">
        </td>
    </tr>
    <tr class="linhanormal">
        <td>
