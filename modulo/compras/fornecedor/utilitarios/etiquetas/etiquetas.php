...
<html>
<head>
<title>.:: Fornecedores p/ Imprimir Etiqueta(s) ::.</title>
...
function enviar() {
    ...
    if(selecionados == 0) {
        ...
        return false
    }else if(selecionados > 24) {
        alert('EXCEDIDO O NÚMERO DE FORNECEDOR(ES) SELECIONADO(S) !\n\nPERMITIDO NO MÁXIMO 24 REGISTROS POR VEZ !')
        return false
    }
    document.form.id_fornecedor2.value      = id_cliente.substr(0, id_cliente.length - 1);
...
/*************************************************************************/
/*Funções referentes a terceira tela depois da consulta - !empty($fornecedores)*/
...
//Aqui tem esse macete porque é para controlar a segunda combo
    ...
    document.form.id_fornecedor2.value  = cliente_sel
    document.form.txt_consultar.value   = '<?=$txt_consultar;?>'	
    document.form.exibir.value          = 0
    document.form.passo.value           = 1
...
//Aqui tem esse macete porque é para controlar a segunda combo
    ...
    document.form.action = 'etiquetas_contatos.php'
    document.form.target = 'novajanela'
    nova_janela('etiquetas_contatos.php', 'novajanela', '', '', '', '', 280, 680, 'c', 'c', '', '', 's', 's', '', '', '')
    document.form.submit()
}
</Script>
</head>
...
<table width='70%' border='0' cellspacing ='1' cellpadding='1' align='center'>
    ...
    <tr class='linhacabecalho' align='center'>
        <td colspan='2'>
            Fornecedores p/ Imprimir Etiqueta(s)
        </td>
    </tr>
    ...
    <tr class='linhanormal'>
        ...
        <td>
            <input type='checkbox' name='opt_internacional' value='1' title='Consultar fornecedores internacionais' class='checkbox' id='label4'>
            <label for='label4'>Internacionais</label>
        </td>
    </tr>
    <tr class='linhanormal'>
        <td colspan='2'>
            <input type='checkbox' name='opcao' onclick='limpar()' value='1' title='Consultar todos os fornecedores' class='checkbox' id='label5'>
...
<?
//Nessa parte simplesmente mostramos a segunda combo com os Fornecedores selecionados da primeira combo ...
...
<table width='70%' border='0' cellspacing='1' cellpadding='1' align='center'>
    ...
    <tr class='linhadestaque' align='center'>
        <td>
            <input type='button' name='cmd_selecionar2' value='Selecionar Todos' title='Selecionar Todos' onclick='selecionar_todos_clientes()' class='botao'>
            <input type='button' name='cmd_retirar2' value='Retirar' title='Retirar' onclick='retirar_cliente()' class='botao'>
            <input type='button' name='cmd_avancar' value='&gt;&gt; Avançar &gt;&gt;' title='Avançar' onclick='enviar_gravar()' class='botao'>
        </td>
    </tr>
</table>
<?}?>
