    ...
    for (i = 0; i < elementos.length; i++) {
        if(document.form.elements[i].type=='select-multiple') {
            for(j = 1; j < document.form.elements[i].length; j++) {
                if(document.form.elements[i][j].selected == true) id_fornecedor = id_fornecedor + document.form.elements[i][j].value + ','
            }
        }
    }
...
<table border="0" width='70%' cellspacing ='1' cellpadding='1' align='center'>
    ...
    <tr class='linhanormal'>
        <td width="20%">
            <input type='checkbox' name='opt_internacional' value='1' title="Consultar fornecedores internacionais" class="checkbox" id='label5'>
            <label for='label5'>Internacionais</label>
        </td>
        <td width="20%">
            <input type='checkbox' name='opcao' onclick='limpar()' value='1' title="Consultar todos os fornecedores" class="checkbox" id='label6'>
