...
<html>
<head>
<title>.:: Relatório de Apuração de ICMS à Creditar (ST) ::.</title>
...
<table width='70%' border='0' cellspacing='1' cellpadding='1' align='center' onmouseover="total_linhas(this)">
    <tr class='linhacabecalho' align='center'>
        <td colspan='3'>
            Relatório de Apuração de ICMS à Creditar (ST)
        </td>
    </tr>
...
/*Busca das NFs que estejam no Período digitado pelo Usuário e com Itens que possuem 
valor de ICMS à Creditar em R$ ...*/
    ...
    <tr class='linhacabecalho' align="right">
        <td colspan='2'>
            <font color='yellow' size='-1'>
                Valor ICMS à Creditar por Empresa => 
            </font>
        </td>
        <td>
...
?>
    <tr class='linhanormal' align='center'>
        <td>
            ...
            <?
/*******************Controle com a Parte de Apresentação dos Números da NF*******************/
                if($campos[$i]['status'] == 6) {//Está sendo acessada uma NF de Devolução ...
                    if(!empty($campos[$i]['snf_devolvida'])) {
                        ...
                        echo '<font color="red" title="NF de Devolução" style="cursor:help"><b>'.faturamentos::buscar_numero_nf($campos[$i]['id_nf'], 'D').'</font>';
                    }
                }else {//Está sendo acessada uma NF normal ...
                    echo '<font title="NF de Saída" style="cursor:help"><b>'.faturamentos::buscar_numero_nf($campos[$i]['id_nf_num_nota'], 'S').'</font>';
                }
/********************************************************************************************/
            ?>
            </a>
