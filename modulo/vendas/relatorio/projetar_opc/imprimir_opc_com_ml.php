...
if($id_pais == 31) {//No Brasil ...
    ...
    $pdf->Cell($GLOBALS['ph'] * 41, 5, 'Discriminação', 1, 0, 'C');
    $pdf->Cell($GLOBALS['ph'] * 11, 5, 'Qtde Proposta', 1, 0, 'C');
    $pdf->Cell($GLOBALS['ph'] * 9, 5, 'Desc Extra', 1, 0, 'C');
    $pdf->Cell($GLOBALS['ph'] * 5, 5, 'ML', 1, 0, 'C');
    ...
    $pdf->Cell($GLOBALS['ph'] * 41, 5, 'Discriminación', 1, 0, 'C');
...
for($i = 0; $i < $linhas; $i++) {
    ...
    $pdf->Cell($GLOBALS['ph'] * 41, 5, $campos[$i]['discriminacao'], 1, 0, 'L');
    $pdf->Cell($GLOBALS['ph'] * 11, 5, $campos[$i]['qtde_proposta'], 1, 0, 'C');
    $pdf->Cell($GLOBALS['ph'] * 9, 5, number_format($campos[$i]['desconto_extra'], 2, ',', '.'), 1, 0, 'C');
    $pdf->Cell($GLOBALS['ph'] * 5, 5, number_format($campos[$i]['margem_lucro'], 1, ',', '.'), 1, 0, 'C');
