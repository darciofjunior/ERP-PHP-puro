...
function options(form, campo, valor, cor_origem){
	...
	linha = eval(valor) + 3
	var cont = valor
/*Só entra aki nessa parte do Script, se eu estiver acessando essa tela de lá do Próprio Módulo de Vendas 
própria parte de Pedidos mesmo, agora se estiver acessando essa tela de lá do Faturamento ele ignora
o restante, porque daí dá problema com os objetos, porque é outra URL*/
