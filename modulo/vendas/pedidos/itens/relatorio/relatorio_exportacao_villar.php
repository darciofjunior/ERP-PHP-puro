...
if($linhas_packing_list > 0) {*/
    ...
    $pdf->SetFont('Arial', '', 10);
    $pdf->Cell(42, 5, '3 caja(s) de madera(s)', 0, 0, 'L');
    $pdf->SetFont('Arial', 'B', 10);
    $pdf->Cell(22, 5, 'Peso Bruto: ', 0, 0, 'L');
    $pdf->SetFont('Arial', '', 10);
    $pdf->Cell(30, 5, '448,559 kg', 0, 0, 'L');
    $pdf->SetFont('Arial', 'B', 10);
    $pdf->Cell(20, 5, 'Peso Neto: ', 0, 0, 'L');
    $pdf->SetFont('Arial', '', 10);
    $pdf->Cell(25, 5, '413,659 kg', 0, 0, 'L');
    $pdf->SetFont('Arial', 'B', 10);
    $pdf->Cell(17, 5, 'Volumén: ', 0, 0, 'L');
    $pdf->SetFont('Arial', '', 10);
    $pdf->Cell(29, 5, '0,6152 m3', 0, 1, 'L');
//}
