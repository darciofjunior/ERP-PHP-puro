...
//Essas Datas eu vou estar passando por parâmetro no relatório de Venda de Produto + abaixo ...
    ...
    for ($i = 0; $i < $linhas; $i++) {
        ...
        //Aqui eu acerto todos os Estoques Possíveis ...
...
<pre>
* O(s) item(ns) acima está(ão) com todos os seus dados de Estoque Acertado(s) Atualizado(s).
