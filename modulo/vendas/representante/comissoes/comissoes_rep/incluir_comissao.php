...
$mensagem[1] = "<font class='confirmacao'>COMISSÃO INCLUÍDA COM SUCESSO.</font>";
...
if(!empty($_POST['txt_margem_lucro'])) {
    ...
    if(count($campos) == 0) {//Comissão existente
        $sql = "INSERT INTO `comissoes` (`id_comissao`, `percentual`, `com_perc_interno`, `com_perc_externo`, `com_perc_externo_esp`, `data_sys`) VALUES (NULL, '$_POST[txt_margem_lucro]', '$_POST[txt_com_vend_interno]', '$_POST[txt_com_vend_externo]', '$_POST[txt_comissao_autonomo]', '$data_sys') ";
        bancos::sql($sql);
        $valor = 1;
    }else {//Comissão existente
        $valor = 2;
    }
}
?>
<html>
<title>.:: Incluir Comissão Desconto ::.</title>
...
<table width='60%' border='0' cellspacing='1' cellpadding='1' align='center'>
    ...
    <tr class='linhanormal'>
        ...
        <td>
            <input type='text' name='txt_margem_lucro' title='Digite a Margem de Lucro' size='8' maxlength='6' onkeyup="verifica(this, 'moeda_especial', '2', '', event)" class='caixadetexto'> %
        </td>
    </tr>
    <tr class='linhanormal'>
        <td>
    ...
    <tr class='linhacabecalho' align='center'>
        <td colspan='2'>
            ...
            <input type='reset' name='cmd_limpar' value='Limpar' title='Limpar' onclick="redefinir('document.form', 'LIMPAR');document.form.txt_margem_lucro.focus()" style='color:#ff9900' class='botao'>
