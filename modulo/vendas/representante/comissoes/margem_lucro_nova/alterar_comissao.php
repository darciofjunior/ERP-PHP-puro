...
$mensagem[1] = "<font class='confirmacao'>NOVA COMISSÃO MARGEM DE LUCRO ALTERADA COM SUCESSO.</font>";
...
//Busca dados da Nova Comissão Margem de Lucro passada por parâmetro ...
$sql = "SELECT * 
        FROM `novas_comissoes_margens_lucros` 
...
?>
<html>
<title>.:: Alterar Nova Comissão Margem de Lucro ::.</title>
...
<table width='70%' border='0' cellspacing='1' cellpadding='1' align='center'>
    ...
    <tr class='linhacabecalho' align='center'>
        <td colspan='2'>
            Alterar Nova Comissão Margem de Lucro
        </td>
    </tr>
