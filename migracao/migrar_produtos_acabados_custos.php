<?
/*Migração da Tabela Produtos Acabados Custos*/
	return migrar_produtos_acabados_custos('', 'produtos_acabados_custos', 'id_produto_acabado, id_produto_insumo, id_funcionario, qtde_lote, peso_kg, peca_corte, comprimento_1, comprimento_2, observacao, operacao_custo', '|');

function migrar_produtos_acabados_custos($arquivo, $tabela, $campos, $separacao) {
