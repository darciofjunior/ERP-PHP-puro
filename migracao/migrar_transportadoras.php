...
/*Migração da Tabela Municípios*/
	return migrar_transportadoras('transportadoras.txt', 'transportadoras', 'nome, endereco, bairro, cidade, fone, fone2', '|');

function migrar_transportadoras($arquivo, $tabela, $campos, $separacao) {
