...
$sql = "SELECT gpa.nome, DATE_FORMAT(ov.data_emissao, '%d/%m/%Y') AS data_emissao, ovi.id_orcamento_venda, ovi.comissao_extra, (ovi.qtde * ovi.preco_liq_final) valor_do_item, pa.referencia, pa.discriminacao 
        ...
        INNER JOIN `orcamentos_vendas` ov ON ov.id_orcamento_venda = ovi.id_orcamento_venda AND ov.data_emissao BETWEEN '2010-04-26' AND '2010-05-25' 
...
<html>
<head>
<title>.:: Comissão Extra paga em 26/04 à 25/05 - Grupo de Limas ::.</title>
...
<table width='70%' border='0' cellspacing='1' cellpadding='1' align='center'>
    <tr class='linhacabecalho' align='center'>
        <td colspan='8'>
            Comissão Extra paga em 26/04 à 25/05 - Grupo de Limas
        </td>
    </tr>
