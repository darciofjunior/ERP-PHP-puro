    ...
    (function($) {
        $.fn.html5lightbox = function(options) {
            ...
            inst.options = jQuery.extend({freelink: "http://html5box.com/", autoplay: true, html5player: true, responsive: true, shownavigation: true, thumbwidth: 96, thumbheight: 72, thumbgap: 4, thumbmargin: 12, thumbborder: 0, thumbbordercolor: "#fff", thumbhighlightborder: 1, thumbhighlightbordercolor: "#fff", thumbopacity: 1, navbuttonwidth: 32, overlaybgcolor: "#000", overlayopacity: 0.7, bgcolor: "#fff", bordersize: 8, borderradius: 0, bordermargin: 16, 
                ...
                nenhum Texto no rodapé da DIV caso seja colocada a propriedade title na tag <a href>*/
                titleinside: {titlecss: "{color:#fff; font-size:14px; font-family:Armata,sans-serif,Arial; overflow:hidden; text-align:left;}"}, titlebottom: {titlecss: "{color:#333; font-size:14px; font-family:Armata,sans-serif,Arial; overflow:hidden; visibility:hidden; text-align:left;}"}, errorwidth: 280, errorheight: 48, errorcss: "{text-align:center; color:#ff0000; font-size:14px; font-family:Arial, sans-serif;}", supportesckey: true, supportarrowkeys: true, version: "3.3", stamp: true, freemark: "", watermark: "", watermarklink: ""},//Esse atributo freemark: "Colocava uma Título nessa DIV com o endereço p/ abrir o Site" -> Default: freemark: "hmtamgli5cboxh.iclolms" 
            options);
            ...
            inst.createMarkup = function() {
                ...
                //$("#html5-lightbox-overlay", inst.$lightbox).click(inst.finish);//Não fecha a DIV quando se clica do lado de fora ...
